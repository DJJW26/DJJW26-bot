module.exports = {
    ...
    execute: async (message) => {
        ...
        message.channel.send(`Your word is... \`${scrambled.join('')}\`! Unscramble the given word. You have 5 lives, good luck!`);
        ...
        collector.on('collect', async (msg) => {
            if (msg.content.toLowerCase() == word.toLowerCase()) {
                return message.channel.send(`That's correct! Good job!`);
                collector.stop();
            }
            else {
            ...
            if (wrong == 3) {
                message.channel.send('You lost your 5 lives, you lose')
            }
        });
